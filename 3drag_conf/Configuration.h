...
#define STRING_VERSION_CONFIG_H "2012-10-02" //Personal revision number for changes to THIS file.
#define STRING_CONFIG_H_AUTHOR "Boris_3Drag" //Who made the changes.
